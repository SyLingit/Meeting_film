package com.meetingfilm.backend.common.generator;
...
public class EntityGenerator {
    ...
    private String outputDir = "/Users/lisiyuan/IdeaProjects/backend-parent/backend-common/src/main/java";
    // 生成类的作者
    private String author = "lsy";
    // 数据源相关配置
    ...
    // DAO的包路径
    private String daoPackage = "com.meetingfilm.backend.common";
    // 待生成的表名，注意是覆盖更新
