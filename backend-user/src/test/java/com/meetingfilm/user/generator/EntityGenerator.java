package com.meetingfilm.user.generator;
...
public class EntityGenerator {
    ...
    private String outputDir = "/Users/lisiyuan/IdeaProjects/backend-parent/backend-user/src/main/java";
    // 生成类的作者
    ...
    // DAO的包路径
    private String daoPackage = "com.meetingfilm.user.dao";
    // 待生成的表名，注意是覆盖更新
